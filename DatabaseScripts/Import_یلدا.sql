-- =============================================
-- Script: Import فایل یلدا.xlsx از Desktop
-- Database: KhanoumiCore
-- =============================================
-- این اسکریپت فایل "یلدا.xlsx" را از Desktop می‌خواند
-- =============================================
...
BEGIN CATCH
    ...
    PRINT '   - یا از اسکریپت PowerShell استفاده کنید: ImportExcelToSQL.ps1'
