-- =============================================
-- Script: Import فایل CSV به جدول GiftCardEligibleUsers
-- Database: KhanoumiCore
-- Description: Import داده‌ها از فایل CSV به جدول GiftCardEligibleUsers
-- =============================================
...
BEGIN TRY
    ...
    DECLARE @FilePath NVARCHAR(4000) = N'C:\Import\data.csv'; -- مسیر فایل (فقط برای نمایش)
    ...
    -- ⚠️ مسیر فایل را در خط زیر تغییر دهید
